...
class ImageOverlay():
    ...
    def generate_image(self):
        ...
        fnt1 = ImageFont.truetype('Aragon_Sans_Bold.otf', 42)

        #this font looks incorrect
        #replaces "xxx"
        fnt3 = ImageFont.truetype('OpenSans-Regular.ttf', 105)
        ...
        img.save('/home/mitchell/Desktop/temporaru/' + self.final_img_id + '.png')
